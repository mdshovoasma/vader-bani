  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="{{route('home')}}">
          <img src="{{asset('deshbord/assets/images/logo/logo.png')}}" alt="logo" width="50" />
        </a>
        <h6>Vader_Bani Dashboard</h6>
      </div>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="{{route('home')}}" class="active"> Vader_Bani </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_2" class="collapse dropdown-nav">
              <li>
                <a href="{{route('category.show')}}"> View all Category </a>
              </li>
              {{-- <li>
          ...
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_3" class="collapse dropdown-nav">
              ...
              <li>
                <a href="{{route('post.show.all')}} "> All Post </a>
              </li>
            </ul>
          </li>
                ...
                <div class="notification-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="notification">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('deshbord/assets/images/lead/lead-6.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            John Doe
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('deshbord/assets/images/lead/lead-1.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>
                            Jonathon
                ...
                <div class="header-message-box ml-15 d-none d-md-flex">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="message">
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('deshbord/assets/images/lead/lead-5.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Jacob Jones</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('deshbord/assets/images/lead/lead-3.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>John Doe</h6>
                    ...
                    <li>
                      <a href="#0">
                        <div class="image">
                          <img src="{{asset('deshbord/assets/images/lead/lead-2.png')}}" alt="" />
                        </div>
                        <div class="content">
                          <h6>Anee Lee</h6>
                ...
                <div class="profile-box ml-15">
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        <div class="image">
                          <img src="{{'https://api.dicebear.com/7.x/avataaars-neutral/svg?seed=auth()->user()->name'}}" alt="User name" />
                        </div>
                        <div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="{{'https://api.dicebear.com/7.x/avataaars-neutral/svg?seed=auth()->user()->name'}}" alt="image">
                        </div>
                        <div class="content">
                    ...
                    <li>
                      ...
                      onclick="event.preventDefault();
                       ...
                       {{ __('Logout') }}
                   </a>  <i class="lni lni-exit"> </i> Sign Out </a>
                    </li>
